...
class Model(nn.Module):
    ...
    def __init__(self, num_class, input_channel, output_channel, hidden_size, imgH, imgW, Transformation, FeatureExtraction,
                  SequenceModeling, Prediction, num_fiducial, batch_max_length):
